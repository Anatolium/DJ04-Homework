...
def page3(request):
    data = {
        ...
        'explanation': "Роботы должны предотвращать ситуации, где их собственная жизнь или работоспособность могут быть"
                       " подвергнуты опасности, но без нарушения первых двух законов."
    }
